...
fn help() void {
    const help_strs = [_][]const u8{
        ...
        "a, A, auto, Auto, AUTO = Auto-solves current board.\n",
        "q, Q, quit, Quit, QUIT = Quits game.\n",
        "u, U, undo, Undo, UNDO = Undoes the last move.\n",
        "r, redo, REDO = Redoes last undone move.\n",
        "R, reset, Reset, RESET = Resets the board.\n",
        "s, S, start, Start, START = Starts board with new peg.\n",
